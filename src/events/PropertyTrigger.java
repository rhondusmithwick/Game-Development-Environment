...
public class PropertyTrigger extends Trigger {
    ...
    public PropertyTrigger(String entityID, Class<? extends IComponent> componentClass, String propertyName, IEntitySystem universe, InputSystem inputSystem) {
    ...
    public String toString() {
        return String.format("%s; %s; %s; %s", getClass().getSimpleName(), entityID, componentClass.getSimpleName(), propertyName);
    }
}
