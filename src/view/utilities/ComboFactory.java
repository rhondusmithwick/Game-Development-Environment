...
public class ComboFactory {
     ...
     *
     * @param String                    prompt the name of the combo box
     * @param List<String>              choices choices in the combo box
     * @param EventHandler<ActionEvent> event event/method to occur when the combo box is selected
