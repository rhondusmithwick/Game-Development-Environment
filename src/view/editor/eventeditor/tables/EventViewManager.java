...
/**
 * Table manager that updates the table that contains the made Events.
 *
 * @author Alankmc
 */
public class EventViewManager extends TableManager {
    ...
    /**
     * With a level picked, get a the Map from the parser, and display the events that were created. 
     */
    @Override
