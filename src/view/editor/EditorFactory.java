...
public class EditorFactory {
	 ...
	 *
	 * @param language
	 *            used in the resource bundle for all editors
	 * @param toEdit
	 *            entity to be edited for editorEntity; entitySystem to be
	 *            edited for editorEnvironment
	 * @param masterEntityList
	 *            - master list with all current entities, observed <br/>
	 *            - editorEntity will add to upon saving, it the editor is not
	 *            already contained in the list <br/>
	 *            - editorEnvironment will use this list to populate its layout
	 * @param entitySystemList
	 *            - master list with all current entity systems (i.e.
	 *            environments), observed <br/>
	 *            - editorEntity will receive an empty one of these, should do
	 *            nothing to <br/>
	 *            - editorEnvironment will add to this upon saving, if the
	 *            system is not already contained in the list
