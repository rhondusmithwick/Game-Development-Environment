...
public interface ILevel extends ISerializable {
     ...
     *
     * @param eventSystemPath string of event system file path
     */
     ...
     */
    default IEntity createEntity () {
        return getEntitySystem().createEntity();
    }
     ...
     */
    default IEntity addEntity (IEntity entity) {
        return getEntitySystem().addEntity(entity);
    }
     ...
     */
    default IEntity getEntity (String id) {
        return getEntitySystem().getEntity(id);
    }
     ...
     */
    default List<IEntity> getAllEntities () {
        return getEntitySystem().getAllEntities();
    }
    ...
    default boolean containsID (String id) {
        return getEntitySystem().containsID(id);
    }
     ...
     */
    default IEntity removeEntity (String id) {
        return getEntitySystem().removeEntity(id);
    }
    ...
    default boolean isEmpty () {
        return getEntitySystem().isEmpty();
    }
    ...
    default IEntity createEntityFromDefault (String defaultFileName) {
        return getEntitySystem().createEntityFromDefault(defaultFileName);
    }
