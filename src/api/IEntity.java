...
public interface IEntity extends ISerializable {
	 ...
	 */
	void addGroupIDs(String... groupIDs);
	 ...
	 *            the class of component
	 * @param index
	 *            the component number that it was inserted
	 * @param <T>
	 *            the type of component
	 ...
	 * @param forceAdd
	 *            whether to force add this component
	 ...
	 * @param forceAdd
	 *            whether to force add these components
	 ...
	 *
	 * @param componentsToAdd
	 *            array/varargs of components to add
	 * @return list of true values that indicates if a component was added
	 ...
	 *
	 * @param componentClassesToRemove
	 *            list of component classes to remove
	 ...
	 *
	 * @param componentClassesToRemove
	 *            array/varargs of component classes to remove
	 * @return list of true values that indicates if a component was removed
	 ...
	 *
	 * @param componentClass
	 *            componentClass whose spec to get
	 ...
	 * @param numToHave
	 *            how many this entity should have of this component
	 * @param <T>
	 *            type of component
	 * @see #getSpecs()
	 */
