...
import voogasalad.util.spriteanimation.config.DoubleConstants;
import voogasalad.util.spriteanimation.main.SpriteUtility;
...
import static voogasalad.util.spriteanimation.config.DoubleConstants.DURATION_DEFAULT;
import static voogasalad.util.spriteanimation.config.DoubleConstants.DURATION_MAX;
import static voogasalad.util.spriteanimation.config.DoubleConstants.DURATION_MIN;
import static voogasalad.util.spriteanimation.config.StringConstants.ANIMATION_NAME_PROMPT;
import static voogasalad.util.spriteanimation.config.StringConstants.STYLE_SHEET;
import static voogasalad.util.spriteanimation.utility.GUIUtilities.makeSlider;
...
public class GUI {
    ...
    private final Label savedAnimationLabel = new Label("Not Saved");
