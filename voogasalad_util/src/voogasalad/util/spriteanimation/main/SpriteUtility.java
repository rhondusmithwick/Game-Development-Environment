...
import voogasalad.util.spriteanimation.gui.Dragger;
import voogasalad.util.spriteanimation.gui.GUI;
import voogasalad.util.spriteanimation.model.ImageLogic;
import voogasalad.util.spriteanimation.model.RectangleDrawer;
import voogasalad.util.spriteanimation.model.RectangleLogic;
import voogasalad.util.spriteanimation.utility.GUIUtilities;

import java.util.HashMap;
import java.util.Map;
import java.util.ResourceBundle;

import static voogasalad.util.spriteanimation.utility.GUIUtilities.makeButton;
import static voogasalad.util.spriteanimation.utility.GUIUtilities.showAlert;
import static voogasalad.util.spriteanimation.utility.GUIUtilities.showError;
import static voogasalad.util.spriteanimation.utility.SaveUtilities.saveAnimations;
import static voogasalad.util.spriteanimation.utility.SaveUtilities.saveImage;
...
public class SpriteUtility {
    ...
    private final ResourceBundle utilityResources = ResourceBundle.getBundle("voogasalad/util/spriteanimation/resources/utilityAlerts");
